...
create table @dataset.vocabulary (
  vocabulary_id                STRING           not null,
...
create table @dataset.concept_class (
  concept_class_id                STRING          not null,
...
create table @dataset.concept_relationship (
...
create table @dataset.relationship (
  relationship_id                STRING           not null,
...
create table @dataset.concept_synonym (
  concept_id                  INT64              not null,
...
create table @dataset.concept_ancestor (
...
create table @dataset.drug_strength (

...
;
select 
(select count(8) from person)
+(select count(8) from observation)
+(select count(8) from condition_occurrence)
+(select count(8) from drug_exposure)
+(select count(8) from visit_occurrence)
+(select count(8) from death)
+(select count(8) from procedure_occurrence)
;
